...
def main():
    ...
    @bot.command(pass_context=True, name='info',\
        ...
        "only the flatterdex numbers with no additional characters.", \
    ...
    async def rebuild(ctx, *args):
        rebuilder(ctx.guild.id)
        await ctx.send("The Flatterbase has been reset to default.")
